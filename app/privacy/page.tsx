...
export const metadata: Metadata = {
  ...
  description: "How Async Tech Pvt Ltd collects and uses information submitted through the Epoch website.",
...
const sections = [
  { heading: "1. Who we are", body: [
    "This Privacy Policy explains how Async Tech Pvt Ltd (\"Async Tech\", \"Epoch\", \"we\", \"us\", or \"our\") handles personal information collected through epochprotocol.xyz (the \"Site\").",
